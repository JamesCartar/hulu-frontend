...
function UpcomingMovie() {
  ...
  useEffect(() => {
    ...
    if(!isLoading || loadMore) {
      axios.get(`https://api.themoviedb.org/3/movie/upcoming?page=${pageCount}`,{
          params: {
      ...
      .then(res => {
        ...
        setUpcomingMovies(oldMovies => ([ ...oldMovies, ...data ]));
      })
  ...
  let upcomingMovieEl = upcomingMovies?.map((movie) => (
