        ...
        <div className='w-full md:w-2/4 mt-16'>
          <div className='p-5 sm:pl-10'>
            ...
            <div className='flex gap-5 mb-10 mt-5'>
              <button aria-label='open trailer' title='trailer' className='bg-primaryfaded bg-primary p-2 px-4 rounded-full flex items-center' onClick={() => handleOpenPopup('currentSeriesTrailer')}><BsFillPlayFill className='text-lg' /> <span className='uppercase text-sm'>Trailer</span></button>
