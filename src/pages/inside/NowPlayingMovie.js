...
function NowPlayingMovie() {
  ...
  useEffect(() => {
    ...
    if(!isLoading || loadMore) {
      axios.get(`https://api.themoviedb.org/3/movie/now_playing?page=${pageCount}`,{
          params: {
      ...
      .then(res => {
        ...
        setNowPlayingMovies(oldMovies => ([ ...oldMovies, ...data ]));
      })
  ...
  let nowPlayingMovieEl = nowPlayingMovies?.map((movie) => (
    <div className='w-48'>
